...
(
  function(C,r,g){
    ...
    function x(a){
      ...
      return l[a.which]?l[a.which]:p[a.which]?p[a.which]:

      String.fromCharCode(a.which).toLowerCase()}function D(a){
        var b=[];
      ...
      function m(a,b,c,f,e){
        ...
        1<g.length?l(a,g,b,c):(c=y(a,c),d._callbacks[c.key]=d._callbacks[c.key]||[],h(c.key,c.modifiers,{type:c.action},f,a,e),d._callbacks[c.key][f?"unshift":"push"]({
          callback:b,modifiers:c.modifiers,action:c.action,seq:f,level:e,combo:a
        }))
      }
      var d=this;
      a=a||r;
    ...
    for(g=1;20>g;++g)
      l[111+g]="f"+g;
    for(g=0;9>=g;++g)
      l[g+96]=g;c.prototype.bind=function(a,b,c){
      ...
      c.init=function(){
        var a=c(r),b;for(b in a)"_"!==b.charAt(0)&&(c[b]=function(b){
          return function(){
