...
class TestPricing(TestCase):
  ...
  def setUpTestData(cls):
    ...
    cls.show1 = Show.objects.create(name='S1', category=cat, description='huh', long_description='ooh', start_date=today, end_date=today + timedelta(days=2))

    cls.season = SeasonTicketPricing.objects.create(season_ticket_price=40)
    cls.in_house = InHousePricing.objects.create(matinee_freshers_price=4, matinee_freshers_nnt_price=5)
